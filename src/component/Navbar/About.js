    ...
    <>
        ...
        <div>
          <div data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className=" ">
            <div className="  text-center">
              <h1 data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="h1seo ">
                <b>
          ...
          <div className="row no-gutters">
            ...
            <div className="col-md-8">
              <div className="card-body vertical1">
                <h3 data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="text-center hashimpara">
                  Founder
                </h3>
                <h4 data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className="card-title hashimpara">
      ...
      <section>
        <div className="text-center container ">
          <div className="row justify-content-center">
            <div data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="col-12 text-center ">
            ...
            <div className="col-md-6 col-lg-3 mb-4">
              <div data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="card rounded-lg hashim1 shade">
                <img
                  loading="lazy"
                  src="zafrullah.jpg"
                  className="card-img-top rounded-circle"
      ...
      <div className="">
        <div className=" col-md-12 mt-5 mb-5 ">
          <h2 data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className=" text-center">
            {" "}
            <b>
          ...
          <div className="container2">
            <div className="container1">
              <div data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' style={{ margin: "auto" }}>
                <MyCircularProgress />
                <div>
              ...
              <div data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="" style={{ margin: "auto" }}>
                <MyCircularProgress1 />
                <div className="">
                  <h3 className="mt-2 underline">
                    <b>Admitted in NED!</b>
              ...
              <div data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className="" style={{ margin: "auto" }}>
                <MyCircularProgress2 />
                <div>
                  <h3 className="mt-2 underline">
                    <b>Registered Now!</b>
          ...
          <div>
            ...
            >
              ...
              <div className="card-body  text-center">
                <h4 data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className="hashimpara card-title">
                ...
                <div data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className="parent-container mb-2">
                  <a
      ...
      <section data-aos="fade-up" data-aos-duration="600" data-aos-easing='ease-out-sine' className="container text-center mt-5 ">
        <h2 data-aos="fade-down" data-aos-duration="600" data-aos-easing='ease-out-sine' className=" mt-5 text-center">
          {" "}
          <b>
