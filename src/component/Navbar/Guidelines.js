    ...
    return (
      <>
        ...
        >
          ...
          syllabus. To do this, it's recommended that you use a combination of
          textbook reading, note-taking, and online resources such as YouTube
          channels and past papers. For the test, you'll need to be familiar
          with four subjects:{" "}
          <b>
            {" "}
            English, Mathematics, Physics, and Chemistry/Computer. Each subject
            will have 25 multiple choice questions, for a total of 100
            questions.
          </b>{" "}
          The passing percentage is 50%, but scoring in the <b>85 range</b> is
          considered a decent score for gaining admission to top-tier
          ...
          <ul>
            ...
            <li data-aos="fade-up">
              ...
              helpful. You can follow channels like{" "}
            ...
            <li data-aos="fade-up">
              ...
              to focus on topics such as C programming language, fundamentals of
              C language, coding rules and regulations, error identification,
              and declaration of output with basic computer. Memorizing shortcut
          ...
          <p data-aos="fade-up">
            ...
            entry test, focus on building a strong foundation of concepts and
            review all intermediate level material covered in the syllabus. Use
            a combination of textbook reading, note-taking, and online resources
            like YouTube channels and past papers to prepare. Remember that each
          ...
          <p data-aos="fade-up">
            ...
            understanding of physics and chemistry concepts, which can be
            revised through practicing any Aptitude material. For mathematics,
            there are several topics, such as intercept concepts, slope one, and
            sequence series, that are not typically covered in O/A-levels, and
            therefore, more effort may be required in this subject. However,
            there are ample resources available on platforms like YouTube to
            learn and practice these topics. You can also refer to ECAT MATHS
            PLAYLIST on my YouTube channel, where I have listed several relevant
            resources. Additionally, attempting the daily tests I post can also
            aid in your preparation. Many of my students who come from A-levels
            background have found my lectures to be highly beneficial. <br />
            To prepare for Aptitude exams, it's important to review and practice
            the concepts from your O/A Level books and Sindh Intermediate books.
            Practice is crucial for scoring well. I have shared study material
            in this website that can be helpful. If you have an A-levels
            background, your admission will be based on your O-levels grades.
            You need to submit your A-levels marks, certificate, and equivalency
            in January. If your A-levels result is released later, you can
            submit it, but a minimum equivalency of 60 is required. It's
            important to focus on both A-levels and Aptitude exams, as students
            with A-levels and O-levels backgrounds often compete for admission.
            Aim for a score of at least 85+ marks in the test.
          </p>
        </section>
        <div>
