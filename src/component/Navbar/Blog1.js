    ...
    return (
        <>
            ...
            <header className="bgimage  text-center py-5">
                <h1 className='text-congrats'>Congratulations on Your Admission to Top Merit Programs of NED University!</h1>
                <h4 className=" italic text-white">Your hard work has paid off, and you're on your way to success.</h4>
            </header>
            {isLoading ? <Loader /> : <>
                ...
                <section>
                    ...
                    <p><strong>C++: Power and Performance</strong></p>
                    <ul>
              ...
              <div className='d-flex  justify-content-center align-items-center'>
                ...
                <section>
                    ...
                    <p>Here are a few YouTube channels that can be highly beneficial to learn programming basic and advance concept:</p>
                    <ul>
                    ...
                    <p>Websites to strengthen your concepts:</p>
                    <ul>
                    ...
                    <p>As responsible senior of BCIT, consider this advice from us. Your future will involve hours of coding and debugging on your laptop or PC. In university, self-study is crucial. No one will spoon-feed you as you might be accustomed to in high school. Professors will provide the basic concepts, but it will be your responsibility to solidify your understanding.</p>

                    <p>It's worth noting that even in fields like electronics, electrical, and telecommunications, there are one or two programming courses (check the course outline in the prospectus). So, this advice applies to all incoming juniors.</p>
                </section>
            </div>

            <footer className=" text-white text-center py-3">
                <p>Feel free to ask any questions on this topic. Your journey has just begun, and with dedication, you'll excel. Contact me at <a href="mailto:owais.ansaricr7@gmail.com">@owaisansari</a></p>
            </footer>
