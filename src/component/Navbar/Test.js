        ...
        {isLoading ? (
          ...
          <div className="container text-center">
            ...
            <p data-aos="fade-down" className=" text-justify  ">
              At NED Admission Cell, we understand that testing one's
              preparation can be a challenging task, especially during the busy
              and demanding days of preparation. That's why we are excited to
              announce our "FREE MOCK TEST" for students pursuing
              Pre-Engineering, Pre-Medical, and Computer Science. Designed based
              on the pattern of NEDUET's entry test, our mock test covers four
              subjects for each group. This presents a unique opportunity for
              students to evaluate their knowledge and expertise in a simulated
              testing environment. We recognize the scarcity of authentic NED
              past papers in the market, and that is why we have taken it upon
              ourselves to provide this service to you at no cost. Additionally,
              we encourage you to share this opportunity with your friends and
              peers who may benefit from these free mock tests. At NED Admission
              Cell, we are committed to assisting you in achieving your academic
              goals, and we believe that this free mock test will help you to
              better prepare for the actual test day.
            </p>
            <div
              data-aos="fade-up"
              data-aos-duration="1300"
            ...
            >
              ...
              <div
                ...
                style={{
                  width: "100%",
                  borderBottom:
                    activeComp === "physics" ? "3px solid blue" : "0",
                  cursor: "pointer",
                }}
